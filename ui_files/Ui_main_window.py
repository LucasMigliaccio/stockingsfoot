...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"../../../Desktop/Softbarber/softbarberr/AngelCuk/assets/icons/minimize-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"../../../Desktop/Softbarber/softbarberr/AngelCuk/assets/icons/restore-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"../../../Desktop/Softbarber/softbarberr/AngelCuk/assets/icons/maximize-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.maximize_button.setIcon(icon2)
        self.close_button = QToolButton(self.butttons_holder_frame)
        self.close_button.setObjectName(u"close_button")
        self.close_button.setGeometry(QRect(60, 0, 22, 22))
        icon3 = QIcon()
        icon3.addFile(u"../../../Desktop/Softbarber/softbarberr/AngelCuk/assets/icons/close-window.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
