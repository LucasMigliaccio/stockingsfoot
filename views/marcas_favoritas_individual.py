...
################################################################################
## Form generated from reading UI file 'marcas_favoritas_individual.ui'
##
...
class ViewMarcaIndividual(object):
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, ViewEmpleado):
        ...
        self.label_tittle.setText(QCoreApplication.translate("ViewEmpleado", u" Marcas Favoritas por Grupo de Ventas", None))
